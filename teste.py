...
def processar_imagens(diretorio_entrada, diretorio_saida, padroes, limiar=0.5):
...
diretorio_entrada = "raiosX"
diretorio_saida = "imgSaida"

# Carregar padrões de área de interesse
padroes = []
diretorio_padroes = "imgsADIprocessadas"
...
# Processar imagens
processar_imagens(diretorio_entrada, diretorio_saida, padroes, limiar=0.5)
